...
const QUIZ = [
  ...
  {
    q: "print(\"End\", end=\"!\") 会怎样？",
    options: ["输出End!，不换行", "输出End!，然后换行", "输出End，然后单独一行!", "报错"],
    answer: 0,
    targetLevel: 1,
  },
  {
  ...
  {
    q: "下面哪个是给变量重新赋值？",
    options: ["把x的值从10改成20", "x == 20", "del x", "print(x)"],
    answer: 0,
    targetLevel: 2,
  },
  {
  ...
  },
  {
    ...
    options: ["可以，类型可以随时变", "不可以，类型定了就不能变", "只有数字之间可以互相改变", "会报错"],
    answer: 0,
    targetLevel: 2,
  },
  ...
  // ---- 数字运算（对应第3关）----
  {
    ...
    options: ["是的，结果还是int", "不一定，可能变成字符串", "会变成浮点数", "取决于数字大小"],
    answer: 0,
    targetLevel: 3,
  },
  {
    q: "一个整数和一个浮点数（小数）相加，结果是什么类型？",
    options: ["浮点数", "整数", "字符串", "报错，不能相加"],
    answer: 0,
    targetLevel: 3,
  },
  {
  ...
  },
  {
    ...
    options: ["不一样，类型不同", "完全一样，只是写法不同", "6.0不合法，Python不能这样写", "取决于变量名"],
    answer: 0,
    targetLevel: 3,
  },
  {
    q: "为什么 Python 3 里，两个整数相除（用 /）结果永远带小数点（比如变成4.0而不是4）？",
    options: ["/ 结果永远是浮点数", "这是一个bug", "只有偶数相除才会这样", "取决于Python的版本设置"],
    answer: 0,
    targetLevel: 3,
  },
  {
  ...
  },
  {
    ...
    options: ["从左到右依次计算", "从右到左计算", "同时计算三个数", "报错，一个表达式最多两个数相乘"],
    answer: 0,
    targetLevel: 3,
  },
  {
    q: "8 / 2 的结果类型是？",
    options: ["浮点数", "整数（4）", "字符串", "报错"],
    answer: 0,
    targetLevel: 3,
  },
  {
  ...
  },
  {
    ...
    options: ["// 取整，/ 有小数", "两者完全一样", "// 更快，结果和/相同", "/ 只能用在整数上"],
    answer: 0,
    targetLevel: 3,
  },
  {
    q: "Python计算表达式的时候，运算符之间有优先级顺序吗？",
    options: ["有，乘除比加减先算", "没有，永远从左往右依次计算", "只有加减法有优先级", "取决于变量名"],
    answer: 0,
    targetLevel: 3,
  },
  {
  ...
  },
  {
    ...
    options: ["按优先级算，先乘除后加减", "严格从左到右，不看运算符种类", "从右到左算", "由用户手动指定顺序"],
    answer: 0,
    targetLevel: 3,
  },
  {
    q: "用 / 除法和用 // 除法，结果的数据类型分别是什么？",
    options: ["/ 结果是浮点数，// 是整数", "两者结果类型完全一样", "/ 是整数，// 是浮点数（和实际相反）", "取决于参与运算的数字大小"],
    answer: 0,
    targetLevel: 3,
  },
  {
  ...
  },
  {
    ...
    options: ["字符串\"2\"", "数字2", "取决于表达式类型", "报错（类型不匹配）"],
    answer: 0,
    targetLevel: 4,
  },
  {
  ...
  {
    q: "input() 函数的作用是？",
    options: ["获取用户输入", "打印内容", "做数学运算", "创建一个函数"],
    answer: 0,
    targetLevel: 5,
  },
  {
  ...
  {
    q: "input() 返回的数据类型是？",
    options: ["字符串", "整数", "小数", "列表"],
    answer: 0,
    targetLevel: 5,
  },
  {
    q: "想把 input() 的结果当成数字来做加法，应该怎么做？",
    options: ["用 int() 转换", "直接加就行", "input() 自动就是数字", "做不到"],
    answer: 0,
    targetLevel: 5,
  },
  {
    q: "input() 会暂停程序，直到用户做什么？",
    options: ["输入并按回车", "关闭浏览器", "点击按钮", "等待5秒"],
    answer: 0,
    targetLevel: 5,
  },
  {
  ...
  },
  {
    ...
    options: ["在输入前显示", "输入后", "不会显示", "只在网页版显示"],
    answer: 0,
    targetLevel: 5,
  },
  {
  ...
  },
  {
    ...
    options: ["字符串\"13\"", "数字13（int）", "None（空值）", "报错（会崩溃）"],
    answer: 0,
    targetLevel: 5,
  },
  {
  ...
  },
  {
    ...
    options: ["报错，无法转换成整数", "n会变成0", "n会变成None", "程序会自动忽略这次输入"],
    answer: 0,
    targetLevel: 5,
  },
  {
    q: "num1 = int(input())\nnum2 = int(input())\nprint(num1 + num2)\n这段代码在做什么？",
    options: ["读入两数相加打印", "只读入一个数字", "把两次输入拼接成字符串", "报错"],
    answer: 0,
    targetLevel: 5,
  },
  {
  ...
  },
  {
    ...
    options: ["去掉前后多余空格", "把输入内容变成大写", "把输入内容反过来", "报错"],
    answer: 0,
    targetLevel: 5,
  },
  {
  ...
  },
  {
    ...
    options: ["float转小数，int转整数", "两者完全一样", "float()更快", "int()能处理小数，float()不能"],
    answer: 0,
    targetLevel: 5,
  },
  ...
  {
    q: "下面哪个说法是对的？",
    options: ["else 不能单独用", "else 可以单独使用", "if 不需要缩进", "if 只能用一次"],
    answer: 0,
    targetLevel: 6,
  },
  {
  ...
  },
  {
    ...
    options: ["没有限制", "最多1个", "最多3个", "不能有elif"],
    answer: 0,
    targetLevel: 6,
  },
  {
  ...
  {
    q: "x = 0\nif x:\n    print(\"真\")\nelse:\n    print(\"假\")\n会打印什么？",
    options: ["假，0是False", "真（0算真值）", "报错（类型错误）", "什么都不打印"],
    answer: 0,
    targetLevel: 6,
  },
  {
  ...
  },
  {
    ...
    options: ["能，遵守命名规则", "不能，必须叫i", "只能是单个字母", "必须提前声明"],
    answer: 0,
    targetLevel: 7,
  },
  {
  ...
  {
    q: "for 循环执行的次数由什么决定？",
    options: ["由range()决定", "由电脑性能决定", "完全随机决定", "必须手动写死次数"],
    answer: 0,
    targetLevel: 7,
  },
  {
  ...
  {
    q: "for i in range(5):\n    if i == 2:\n        continue\n    print(i)\n会打印哪些数字？",
    options: ["0,1,3,4", "0,1,2,3,4", "只打印2", "只打印0,1"],
    answer: 0,
    targetLevel: 7,
  },
  {
  ...
  },
  {
    ...
    options: ["跳到下一次循环", "立刻跳出循环", "结束程序", "什么都不做"],
    answer: 0,
    targetLevel: 8,
  },
  {
    q: "while循环最容易犯的错误是什么？",
    options: ["忘记让条件变化", "变量名起错", "忘记print", "用了中文标点"],
    answer: 0,
    targetLevel: 8,
  },
  {
  ...
  },
  {
    ...
    options: ["让条件变量发生变化", "多写几个print", "把条件写成True", "什么都不用做"],
    answer: 0,
    targetLevel: 8,
  },
  {
  ...
  },
  {
    ...
    options: ["可以，能用and/or", "不可以，while只能跟一个条件", "只有if能用and/or", "会报错"],
    answer: 0,
    targetLevel: 8,
  },
  {
  ...
  },
  {
    ...
    options: ["break跳出，continue跳过", "两者效果完全一样", "break只能用在for里", "continue会结束整个程序"],
    answer: 0,
    targetLevel: 8,
  },
  ...
  {
    q: "nums[1:3] 这种写法叫什么？",
    options: ["切片，取下标1-2", "取第1到第3个", "报错（语法错误）", "删除操作"],
    answer: 0,
    targetLevel: 9,
  },
  {
  ...
  {
    q: "nums = [1, 2, 3]\nnums.insert(0, 0)\nprint(nums)\n会输出什么？",
    options: ["[0, 1, 2, 3]", "[1, 2, 3, 0]", "[0, 2, 3]", "报错（下标错误）"],
    answer: 0,
    targetLevel: 9,
  },
  {
  ...
  {
    q: "nums = [3, 1, 2]\nprint(sorted(nums))\nprint(nums)\n第二行打印的nums是？",
    options: ["[3, 1, 2]", "[1, 2, 3]（原列表也被排序了）", "报错", "[]"],
    answer: 0,
    targetLevel: 9,
  },
  {
  ...
  {
    q: "字典的键（key）可以重复吗？",
    options: ["不可以，会覆盖旧值", "可以，都会保留", "可以，但会报警告", "取决于值的类型"],
    answer: 0,
    targetLevel: 10,
  },
  {
  ...
  {
    q: "字典的键一般用什么类型？",
    options: ["字符串或数字", "只能是字符串", "只能是数字", "可以是列表"],
    answer: 0,
    targetLevel: 10,
  },
  {
  ...
  },
  {
    ...
    options: ["取age，无则返回0", "把age设成0", "删除age这个键", "报错（键不存在）"],
    answer: 0,
    targetLevel: 10,
  },
  {
    q: "d = {\"a\": 1, \"b\": 2}\ndel d[\"a\"]\nprint(d)\n会输出什么？",
    options: ["{'b': 2}", "{'a': 1}", "{}（空字典）", "报错（键不存在）"],
    answer: 0,
    targetLevel: 10,
  },
  {
  ...
  {
    q: "d1 = {\"a\": 1}\nd2 = {\"b\": 2}\nd1.update(d2)\nprint(d1)\n会输出什么？",
    options: ["{'a': 1, 'b': 2}", "{'a': 1, 'b': 1}", "{'a': 2, 'b': 2}", "报错"],
    answer: 0,
    targetLevel: 10,
  },
  {
  ...
  },
  {
    ...
    options: ["可以，键不限字符串", "不可以，键只能是字符串", "只有0可以当键", "会报错"],
    answer: 0,
    targetLevel: 10,
  },
  ...
  {
    q: "函数最大的好处是？",
    options: ["避免重复写代码", "让代码运行变快", "让代码变得更长", "没有好处"],
    answer: 0,
    targetLevel: 11,
  },
  {
  ...
  },
  {
    ...
    options: ["不需要，各自独立命名", "必须一样，否则报错", "只有第一个参数需要一样", "取决于参数类型"],
    answer: 0,
    targetLevel: 11,
  },
];
